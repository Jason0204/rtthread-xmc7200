...
int can_sample(void)
{
    ...
    /* 创建数据接收线程 */
    thread_rx = rt_thread_create("can_rx", can_rx_thread, RT_NULL, 1024, 25, 10);
    ...
    /* 创建数据接收线程 */
    thread_tx = rt_thread_create("can_tx", can_tx_thread, RT_NULL, 512, 20, 10);
